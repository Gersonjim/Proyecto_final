...
<body>
    ...
    <section class="citas mt-5">
        ...
        // Consulta para obtener las fechas ya agendadas (ocupadas)
        $result = $conexion->query("SELECT fecha FROM citas_agendadas");
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            let fechasOcupadas = <?php echo json_encode($fechasOcupadas); ?>;
            ...
            flatpickr("#fecha", {
                ...
                onDayCreate: function (dObj, dStr, fp, dayElem) {
                    ...
                    if (fechasOcupadas.includes(dayElem.dateObj.toISOString().split('T')[0])) {
